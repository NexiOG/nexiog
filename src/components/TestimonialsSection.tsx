    ...
    <>
      ...
      <section id="testimonials" className="py-24 relative z-10 overflow-hidden">
        ...
        <div className="relative w-full max-w-[100vw] overflow-hidden">
          {/* Fading Edges */}
          <div className="absolute top-0 bottom-0 left-0 w-16 md:w-40 bg-gradient-to-r from-[#0a0514] to-transparent z-20 pointer-events-none" />
          <div className="absolute top-0 bottom-0 right-0 w-16 md:w-40 bg-gradient-to-l from-[#0a0514] to-transparent z-20 pointer-events-none" />
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="relative w-28 h-28 mb-6 group-hover:scale-105 transition-transform duration-500">
                    ...
                    <div className={`w-full h-full rounded-full overflow-hidden relative flex items-center justify-center shadow-[inset_0_4px_10px_rgba(255,255,255,0.3),inset_0_-6px_15px_rgba(0,0,0,0.8),0_0_20px_rgba(129,74,200,0.4)] bg-gradient-to-br ${
                      ["from-[#f43f5e] to-[#9f1239]", "from-[#8b5cf6] to-[#4c1d95]", "from-[#0ea5e9] to-[#0369a1]", "from-[#10b981] to-[#047857]", "from-[#f59e0b] to-[#b45309]"][index % 5]
                    }`}>
                      <span 
                  ...
                  <p className="text-[#a78bfa] text-xs font-bold mb-6 uppercase tracking-wider">{item.role}</p>
